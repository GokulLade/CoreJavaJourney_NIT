package com.nareshit.I_collection_framework_in_java.B_CollectionInterface.B_SetInterface.E_NavigableSetInterface;

import java.util.NavigableSet;
import java.util.TreeSet;

public class MethodOfNavigableSetInterface {
