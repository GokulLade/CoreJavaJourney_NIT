...
public class FlatMapToDoubleMethodProgram01 {
	...
	public static void main(String[] args) 
	{
		...
		List<double[]> listOfDoubleArrays = Arrays.asList(d1,d2,d3); DoubleStream doubleStream =
		listOfDoubleArrays.stream().flatMapToDouble(array -> DoubleStream.of(array));
